...
struct StoryBrain {
    ...
    mutating func nextStory(_ userChoice : String){
        ...
        if userChoice == stories[currentQuestion].choice1 {
            currentQuestion = stories[currentQuestion].choice1Destination
        }else {
            currentQuestion = stories[currentQuestion].choice2Destination
        }
    ...
    func getTitle() -> String{
        return stories[currentQuestion].title
    }
